...
def get_trading212_live_data():
    ...
    try:
        ...
        cash_data = cash_resp.json() if cash_resp.status_code == 200 else {'free': 0, 'total': 0, 'ppl': 0}
...
<div class="header-bar">
    <div class="header-left">
        ...
        <div class="terminal-title">SMARTBOT</div>
        <div class="status-indicator">
            <span class="status-dot"></span>
            <span>LIVE TRADING</span>
        </div>
        {"<div class='status-indicator'><span>PID: " + pid + "</span></div>" if pid else ""}
    </div>
...
<div class="main-grid">
    <div class="metric-card">
        ...
        <div class="metric-subtitle">Free: ${free:,.2f} | Invested: ${invested:,.2f} | Blocked: ${blocked:,.2f}</div>
    </div>
